...
try {
    ...
    $createdPaymentPosting = Invoke-RestMethod -Uri "$ApiBaseUrl/api/billing/payments/insurance-payments" -Method Post -Headers (Get-AdministrationHeaders) -ContentType "application/json" -Body $createPaymentPostingBody -TimeoutSec 20
...
try {
    ...
    $createdPatientPayment = Invoke-RestMethod -Uri "$ApiBaseUrl/api/billing/payments/patient-payments" -Method Post -Headers (Get-AdministrationHeaders) -ContentType "application/json" -Body $createPatientPaymentBody -TimeoutSec 20
