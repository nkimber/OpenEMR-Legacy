...
- Patient duplicate detection is covered by Slice 191, registration validation is covered by Slice 192, deceased-status date/reason administration is covered by Slice 193, mother/guardian contact administration is covered by Slice 194, guardian demographic/address administration is covered by Slice 195, patient social-detail administration is covered by Slice 196, and employer identity/address administration is covered by Slice 197. Guarantor/subscriber insurance-party demographics, validation catalogs, patient history, lifecycle audit history, and broader administration policy enforcement remain deferred.
...
- Patient duplicate detection is covered by Slice 191, OpenEMR-style registration validation readiness is covered by Slice 192, deceased-status date/reason administration is covered by Slice 193, mother/guardian contact administration is covered by Slice 194, guardian demographic/address administration is covered by Slice 195, patient social-detail administration is covered by Slice 196, and employer identity/address administration is covered by Slice 197. Patient merge, guarantor/subscriber insurance-party capture, portal account provisioning, address validation, facility/provider assignment, lifecycle audit history, and broader administration policy enforcement remain deferred.
