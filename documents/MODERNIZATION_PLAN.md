...
- Patient duplicate detection is covered by Slice 191, registration validation is covered by Slice 192, deceased-status date/reason administration is covered by Slice 193, and mother/guardian contact administration is covered by Slice 194. Guarantor/subscriber insurance-party demographics, validation catalogs, patient history, lifecycle audit history, and broader administration policy enforcement remain deferred.
...
- Patient duplicate detection is covered by Slice 191, OpenEMR-style registration validation readiness is covered by Slice 192, deceased-status date/reason administration is covered by Slice 193, and mother/guardian contact administration is covered by Slice 194. Patient merge, guarantor/subscriber insurance-party capture, portal account provisioning, address validation, facility/provider assignment, lifecycle audit history, and broader administration policy enforcement remain deferred.
