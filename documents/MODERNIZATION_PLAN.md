...
- The modernized Calendar renders skipped-date metadata. Generated occurrence mutation is introduced in Slice 106 for occurrence cancellation only.
...
- This slice covers read-only seeded exception-date expansion only. Generated occurrence cancellation through new exception dates is covered by Slice 106. It does not edit exception dates directly, propagate edits across a recurring series, cover monthly repeat-on rules, support days-of-week recurrence editing, validate provider availability/resource conflicts, send reminders, manage waitlists, or convert appointments into encounters/billing.
...
- This slice covers cancelling/skipping a generated occurrence only. It does not reschedule an individual occurrence, edit exception dates directly, propagate edits across a recurring series, cover monthly repeat-on rules, support days-of-week recurrence editing, validate provider availability/resource conflicts, send reminders, manage waitlists, or convert appointments into encounters/billing.
