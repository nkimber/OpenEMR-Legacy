...
- This slice covers simple monthly interval recurrence only. Day, workday, and yearly recurrence units are covered by Slice 113. It does not cover monthly repeat-on rules such as first Monday, arbitrary weekday selection, provider availability/resource conflicts, reminders, waitlists, or appointment conversion into encounters/billing.
...
- This slice covers simple interval recurrence units for day, workday, and year. It does not cover monthly repeat-on rules, arbitrary weekday selection, provider availability/resource conflicts, reminders, waitlists, or appointment conversion into encounters/billing.
