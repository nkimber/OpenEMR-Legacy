...
- The modernized Calendar renders skipped-date metadata and continues to keep generated occurrences read-only.
...
- This slice covers read-only seeded exception-date expansion only. It does not create, edit, or delete exception dates, propagate edits across a recurring series, cover monthly repeat-on rules, support days-of-week recurrence editing, validate provider availability/resource conflicts, send reminders, manage waitlists, or convert appointments into encounters/billing.
