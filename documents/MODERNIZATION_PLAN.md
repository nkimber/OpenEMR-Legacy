...
- Patient duplicate detection is covered by Slice 191, registration validation is covered by Slice 192, deceased-status date/reason administration is covered by Slice 193, mother/guardian contact administration is covered by Slice 194, guardian demographic/address administration is covered by Slice 195, patient social-detail administration is covered by Slice 196, employer identity/address administration is covered by Slice 197, and primary-provider assignment administration is covered by Slice 198. Guarantor/subscriber insurance-party demographics, validation catalogs, patient facility/care-team mapping, patient history, lifecycle audit history, and broader administration policy enforcement remain deferred.
...
- Patient duplicate detection is covered by Slice 191, OpenEMR-style registration validation readiness is covered by Slice 192, deceased-status date/reason administration is covered by Slice 193, mother/guardian contact administration is covered by Slice 194, guardian demographic/address administration is covered by Slice 195, patient social-detail administration is covered by Slice 196, employer identity/address administration is covered by Slice 197, and primary-provider assignment is covered by Slice 198. Patient merge, guarantor/subscriber insurance-party capture, portal account provisioning, address validation, patient facility/care-team mapping, lifecycle audit history, and broader administration policy enforcement remain deferred.
