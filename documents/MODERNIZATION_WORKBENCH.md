...
- The API can run the shared slice-18 admin facility mutation readiness parity plan, the shared slice-19 admin user mutation readiness parity plan, the shared slice-20 access-control readiness parity plan, and the shared slice-21 access-permission mutation readiness parity plan for both legacy and modernized targets.
