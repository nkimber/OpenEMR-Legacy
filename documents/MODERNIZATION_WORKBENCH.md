...
Slice 143 adds the functionality progress ledger to the Progress page. Slice 146 adds explicit scope-adjusted completion estimates to that ledger. Slice 152 adds weighted overall progress, Git-backed progress history, and rough remaining-time forecasting. Slice 155 adds direct comparison-side links to run JSON, Playwright JSON, JUnit XML, and HTML reports. Slice 202 adds managed patient history/lifestyle plan actions for both legacy and modernized targets; Slice 201 patient care-team contact actions, Slice 200 patient care-team members actions, Slice 199 patient care-team actions, Slice 198 patient provider assignment actions, Slice 197 patient employer core actions, Slice 196 patient social-details actions, Slice 195 patient guardian-details actions, Slice 194 patient guardian-contact actions and Slice 193 patient deceased-status actions, Slice 192 patient registration validation actions, Slice 191 patient duplicate detection actions, Slice 190 encounter amendment history actions, Slice 189 appointment mutation authorization-policy actions, Slice 188 billing mutation authorization-policy actions, Slice 187 message mutation authorization-policy actions, Slice 186 document mutation authorization-policy actions, Slice 185 encounter mutation authorization-policy actions, Slice 184 patient mutation authorization-policy actions, and Slice 183 procedure mutation authorization-policy actions remain available; earlier protection and authorization-policy actions remain available.
...
- The API can run the shared slice-18 admin facility mutation readiness parity plan, the shared slice-19 admin user mutation readiness parity plan, the shared slice-20 access-control readiness parity plan, the shared slice-21 access-permission mutation readiness parity plan, the shared slice-22 user group membership mutation readiness parity plan, the shared slice-159 through slice-202 authentication, protection, authorization-policy, mutation authorization-policy, encounter amendment history, patient duplicate detection, patient registration validation, patient deceased status, patient guardian contact, patient guardian details, patient social details, patient employer, patient provider assignment, patient care-team, patient care-team members, patient care-team contact, and patient history readiness parity plans for both legacy and modernized targets.
...
The reusable parity test harness lives in `parity-tests/` and is launched by `scripts/Run-OpenEmrParityTests.ps1`. It currently provides database, HTTP, Playwright UI, workflow mutation, named run plans, a side-by-side slice-1 readiness plan through a side-by-side slice-202 patient history readiness plan, and full-suite legacy runs.
