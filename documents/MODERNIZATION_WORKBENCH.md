...
- The API can run the shared slice-12 encounter mutation readiness, slice-168 encounter protection readiness, slice-169 document protection readiness, slice-170 message protection readiness, slice-171 billing protection readiness, and slice-172 procedure protection readiness parity plans for both legacy and modernized targets.
