...
- The API can run the shared slice-139 procedure lab provider catalog, slice-140 procedure lab provider directory, slice-141 procedure lab provider lifecycle, slice-142 procedure lab provider configuration, slice-144 procedure lab provider address-book, slice-145 procedure order catalog readiness, slice-147 procedure order catalog lifecycle, slice-148 procedure vendor compendium import, and slice-149 procedure order queue parity plans for both legacy and modernized targets.
