...
- Claim status, payment posting, account balance, account aging, and account ledger coverage, with deeper revenue-cycle behavior later once the project selects those workflows.
