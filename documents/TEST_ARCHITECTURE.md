...
The modernized target now exists and includes implemented workflow slices through Slice 520. The smoke test proves that the target can run, consume the shared gold dataset, retrieve deterministic anchors across patient, duplicate detection, registration validation, deceased status, guardian contact, guardian details, social details, employer details, provider assignment, care-team membership, patient history/lifestyle, insurance coverage and subscriber details, patient portal account/reset/access/authentication/session/home/profile/profile review queue/accept/revert/home immunization health-snapshot/clinical-summary allergy/problem and medication date-column/prescription modified-date/start-date/end-date filtering/lab-results/medical-report/generated-report/appointment/request/secure-message/document readiness, immunization history, scheduling, encounter, revenue-cycle, procedure lab-provider ownership, directory, lifecycle, configuration, address-book, order-catalog, and clinical order queue views, document, administration, access-control, reporting, and clinical-list workflows, create/validate/end an admin session, record login audit evidence, enforce protected login-audit access, enforce protected administration directory access, enforce ACL-backed administration authorization, enforce protected operational reports and CSV export access, enforce ACL-backed operational reports authorization, enforce protected patient search/chart access, enforce ACL-backed patient chart authorization, enforce patient duplicate detection, enforce patient registration validation row safety, enforce protected clinical-list access, enforce ACL-backed clinical-list authorization, enforce protected appointment search access, enforce ACL-backed appointment authorization, enforce view/write appointment mutation authorization, enforce protected encounter search access, enforce ACL-backed encounter authorization, enforce encounter amendment history projection, enforce protected patient document access, enforce protected patient message access, enforce ACL-backed patient message authorization, enforce protected billing access, enforce ACL-backed billing authorization, enforce protected procedure access, enforce ACL-backed procedure authorization, enforce add/write/sign procedure mutation authorization, enforce add/write patient mutation authorization, enforce view/write encounter mutation authorization, enforce add/write/delete document mutation authorization, enforce add/write message mutation authorization, enforce view/write billing mutation authorization, and perform safe cleanup-backed mutation lifecycles for patient, patient portal reset, patient portal access, patient portal session logout, patient portal profile change requests/review queues/review acceptance/review revert, patient portal secure-message composition/recipient-directory/subject-presets/HTML body rendering/pagination/search/folder-search/empty-search/search-counts/clear-search/search-normalization/search-selection/search mark-all-read/mark-all-read/reply/thread view/archive/read-status/batch-archive/all-folder/lifecycle audit/encrypted-body protection/forward-to-practice/deleted-folder/notification projection/attachment metadata/unsupported attachment policy, patient portal document list/download, patient portal appointment list, patient portal appointment request, patient portal appointment request options, patient portal profile, patient portal home immunization health-snapshot, patient portal clinical-summary allergy/problem and medication date-column and prescription modified-date/start-date/end-date filtering, patient portal lab results, patient portal medical report, patient portal generated report, patient portal generated report PDF export, patient portal generated report issue selection, patient portal generated report encounter-form selection, patient portal generated report procedure-order selection, patient portal generated report procedure-order artifact delivery, patient portal generated report printable template metadata, patient portal generated report package delivery, patient portal generated report lifecycle audit, patient deceased status, patient guardian contact, patient guardian details, patient social details, patient employer details, patient provider assignment, patient care-team membership, patient contact-backed care-team membership, patient insurance subscriber coverage, patient-message reply/content/assignment, scheduling, encounter, document, revenue-cycle, procedure lab-provider lifecycle/configuration/address-book, procedure order catalog lifecycle/import, procedure order queue/transmit, procedure report bulk sign-off/reopen review, administration, and ACL workflow slices.

The slice readiness plans from `slice-1-readiness` through `slice-520-patient-portal-message-search-mark-all-read-readiness` prove the same normalized database facts, browser-visible behavior, mutation/session/audit/encrypted-body/forwarding/deleted-folder/notification/attachment-metadata/unsupported-attachment-policy/selected-procedure-order, selected-artifact, recipient-routing, subject-preset, sanitized HTML body, folder-pagination, folder-search, empty-search states, search-count summaries, clear-search behavior, search-normalization behavior, search-selection behavior, filtered mark-all-read behavior, browser-only mark-all-read post-state, patient portal profile demographics/insurance, profile pending-review, staff review queue, staff accept, and staff revert expectations where applicable, cleanup, and restoration expectations against both legacy and modernized targets. Slice 520 verifies patient portal secure-message search mark-all-read behavior by creating cleanup-backed matching and hidden unread Inbox rows, proving search hides one unread row from the shared projection, documenting the installed legacy no-search-filter baseline, and confirming the modernized Portal marks only filtered rows read while hidden unread rows remain New when search is cleared. Slice 519 verifies patient portal secure-message search-selection behavior by creating cleanup-backed matching and selected-then-hidden Inbox rows, proving search hides the selected row from the shared projection, documenting the installed legacy no-search-filter baseline, and confirming the modernized Portal clears the hidden selection and disables Archive selected. Slice 518 verifies patient portal secure-message search-normalization behavior by creating cleanup-backed matching and decoy Inbox rows, proving padded mixed-case search text is trimmed and matched case-insensitively, documenting the installed legacy no-search-input/no-live-summary baseline, and confirming the modernized Portal search-count summary is exposed as a polite live status. Slice 517 verifies patient portal secure-message clear-search behavior by creating cleanup-backed Inbox rows, proving a matching query narrows the projection and clearing the query restores both rows, documenting the installed legacy no-search-input/no-clear-control baseline, and confirming the modernized Portal Clear search control clears the query, disables itself, resets paging, and restores the Inbox list. Slice 516 verifies patient portal secure-message search-count behavior by creating cleanup-backed Inbox, Sent, and archived Deleted rows, proving filtered/total counts for Inbox/Sent/All/Deleted projections, documenting the installed legacy no-search-input baseline, and confirming the modernized Portal search-count summary reports the expected counts. Slice 515 verifies patient portal secure-message empty-search behavior by creating cleanup-backed Inbox, Sent, and archived Deleted rows, proving a no-hit query returns zero shared matches across Inbox/Sent/All/Deleted projections, documenting the installed legacy no-search-input baseline, and confirming the modernized Portal shows deterministic folder-specific empty states before clearing back to restored rows. Slice 514 extends patient portal secure-message search coverage by creating cleanup-backed sent and archived rows, proving Sent/All and Deleted search projections, documenting the installed legacy Sent/Archive no-search-input baseline, and confirming the modernized Portal search field filters Sent, All, and Deleted rendered regions. Slice 513 verifies patient portal secure-message search by creating cleanup-backed matching and decoy inbox rows, applying a case-insensitive substring query before pagination at the workflow/data level for both targets, documenting the inactive/no-search-input legacy rendered baseline, and confirming the modernized Portal search field filters the rendered Inbox. Slice 512 verifies patient portal secure-message unsupported attachment policy on both targets by attempting a non-empty attachment submission, proving the request is rejected before mailbox rows are created, and confirming active upload controls are absent on the secure-message surfaces. Slice 510 verifies patient portal secure-message attachment metadata readiness on both targets by composing cleanup-backed portal mailbox rows, proving sent and recipient copies currently expose `attachmentCount: 0` and empty `attachments` arrays, checking the modernized Portal renders `Attachments 0` on sent-message cards, and, with Slice 511, attaching precondition, creation, projection, cleanup, target UI, and UI-cleanup JSON evidence. Slice 255 verifies patient portal secure-message notification readiness on both targets; the legacy side reads cleanup-backed active `patient_reminders` rows through the portal notification merge, while the modernized side projects cleanup-backed `patient_reminders` rows through the patient portal API and renders read-only Notification rows in Inbox and All. Slice 254 verifies patient portal profile review revert readiness on both targets; the legacy side mirrors OpenEMR's `Revert Edits` modal behavior by closing the cleanup-backed `onsite_portal_activity` row with chart-original demographics, while the modernized side closes the cleanup-backed `patient_portal_profile_change_requests` row through the administration revert API and Admin `Revert Edits` button without changing chart demographics. Earlier workflow plans remain stable for the implemented patient, scheduling, encounter, document, revenue-cycle, lab/procedure, administration, ACL, reporting, and clinical-list slices.
