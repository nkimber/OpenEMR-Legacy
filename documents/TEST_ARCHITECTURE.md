...
- `slice-212-patient-portal-reply-readiness` runs the patient portal secure-message reply and thread-linkage suite with a per-test reset for both legacy and modernized targets.
