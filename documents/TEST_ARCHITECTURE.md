...
- `mutation-isolated` runs legacy workflow mutations and shared patient contact, patient demographics, patient registration, appointment, encounter, encounter metadata, clinical-list allergy, problem-list, medication-list, message, document, binary document, document sign-off, document external-link, document denial, document metadata, insurance, prescription, immunization, billing, procedure, admin-facility, admin-user, access-permission, and user-group-membership mutation suites with per-test resets for strongest mutation isolation.
- `full-parity` runs database, HTTP, UI, workflow, patient contact mutation, patient demographics mutation, patient registration mutation, appointment mutation, encounter mutation, encounter metadata mutation, clinical-list mutation, problem-list mutation, medication-list mutation, message mutation, document mutation, binary document mutation, document sign-off mutation, document external-link mutation, document denial mutation, document metadata mutation, insurance mutation, prescription mutation, immunization mutation, billing mutation, procedure mutation, admin facility mutation, admin user mutation, access-permission mutation, user-group-membership mutation, access-control read-model coverage, pending/scheduled procedure-order coverage, reports export coverage, patient documents coverage, patient document content coverage, insurance coverage, and immunization history coverage as the target-neutral contract intended for future side-by-side legacy and modernized runs.
