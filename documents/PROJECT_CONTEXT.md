...
Current update: Slice 135 adds procedure report review queue readiness. The latest Workbench-specific slice remains Slice 125, which adds safe artifact links; the latest modernized OpenEMR workflow slice is Slice 135, and the target now covers thirty-eight read-only vertical slices plus ninety-five mutation-capable slices through Slice 135.
