...
Current update: Slice 125 adds Workbench artifact links. The latest modernized OpenEMR workflow slice remains Slice 123, which covers encounter document replacement revision readiness; the target still covers thirty-eight read-only vertical slices plus eighty-five mutation-capable slices through Slice 123.
