...
Current update: Slice 132 adds procedure order correction readiness. The latest Workbench-specific slice remains Slice 125, which adds safe artifact links; the latest modernized OpenEMR workflow slice is Slice 132, and the target now covers thirty-eight read-only vertical slices plus ninety-two mutation-capable slices through Slice 132.
