...
Current update: Slice 126 adds encounter scanned attachment readiness. The latest Workbench-specific slice remains Slice 125, which adds safe artifact links; the latest modernized OpenEMR workflow slice is Slice 126, and the target now covers thirty-eight read-only vertical slices plus eighty-six mutation-capable slices through Slice 126.
