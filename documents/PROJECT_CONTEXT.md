...
Current update: Slice 139 adds procedure lab provider catalog readiness. The latest Workbench-specific slice remains Slice 125, which adds safe artifact links; the latest modernized OpenEMR workflow slice is Slice 139, and the target now covers thirty-nine read-only vertical slices plus ninety-eight mutation-capable slices through Slice 139.
