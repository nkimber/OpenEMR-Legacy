...
Current update: Slice 168 adds encounter protection readiness. The modernized target is current through Slice 168, while the Workbench can run direct Slice 168 encounter protection plan actions and still opens comparison-side run JSON, Playwright JSON, JUnit XML, and HTML report evidence from Test Runs drill-ins.
