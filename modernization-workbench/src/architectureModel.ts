...
export function buildArchitectureModel(summaries: ArchitectureSystemSummary[]): ArchitectureModel {
  ...
  const modernized = summaryFor(summaries, "modernized-openemr", {
    ...
    status: "Slice 88 patient image document preview readiness implemented",
    stack: [],
    database: "PostgreSQL",
    ...
    systems: [
      {
        ...
        evidence: [
          ...
          "Side-by-side parity plans exist through Slice 88 patient image document preview readiness."
        ]
      },
      {
        ...workbench,
