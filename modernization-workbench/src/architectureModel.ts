...
export function buildArchitectureModel(summaries: ArchitectureSystemSummary[]): ArchitectureModel {
  ...
  const modernized = summaryFor(summaries, "modernized-openemr", {
    ...
    status: "Slice 87 encounter external-link document readiness implemented",
    stack: [],
    database: "PostgreSQL",
    ...
    systems: [
      {
        ...
        evidence: [
          ...
          "Side-by-side parity plans exist through Slice 87 encounter external-link document readiness."
        ]
      },
      {
        ...workbench,
