...
export function buildArchitectureModel(summaries: ArchitectureSystemSummary[]): ArchitectureModel {
  ...
  const modernized = summaryFor(summaries, "modernized-openemr", {
    ...
    status: "Slice 86 encounter document lifecycle timeline readiness implemented",
    stack: [],
    database: "PostgreSQL",
    ...
    systems: [
      {
        ...
        evidence: [
          ...
          "Side-by-side parity plans exist through Slice 86 encounter document lifecycle timeline readiness."
        ]
      },
      {
        ...workbench,
