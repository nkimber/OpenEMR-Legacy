...
app.get("/api/progress", async (_request, response) => {
  response.json({
    slices: [
      ...
      { id: "seed-data", name: "Synthetic seed data", status: "verified", detail: "Workbench owns the shared gold dataset; the 1,000-patient legacy seed now includes 2,648 immunization rows and 700 claim status rows and is generated with count/temporal-coverage verification." },
