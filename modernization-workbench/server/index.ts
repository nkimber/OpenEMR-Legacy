...
app.get("/api/progress", async (_request, response) => {
  response.json({
    slices: [
      ...
      { id: "modernized-target", name: "Modernized OpenEMR target", status: "in-progress", detail: "Slice 44 adds fee-sheet ICD10 diagnosis coding behavior to the React Fees workspace, Workbench actions, smoke coverage, and side-by-side billing diagnosis parity evidence." }
    ]
  });
});
