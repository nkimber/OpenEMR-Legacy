...
app.get("/api/progress", async (_request, response) => {
  response.json({
    slices: [
      ...
      { id: "test-management", name: "Parity test management", status: "verified", detail: "Named run plans are implemented for legacy readiness, isolated workflow mutations, patient chart parity, scheduling parity, encounter SOAP/vitals parity, clinical-list parity, messaging parity, procedure-result parity, pending procedure-order parity, report-export parity, fee-sheet billing parity, administration directory parity, operational reporting parity, patient contact mutation parity, appointment mutation parity, encounter mutation parity, clinical-list mutation parity, patient-message mutation parity, prescription mutation parity, billing mutation parity, procedure mutation parity, admin facility mutation parity, admin user mutation parity, access-control parity, access-permission mutation parity, user group membership mutation parity, and the future full parity contract." },
      { id: "modernized-target", name: "Modernized OpenEMR target", status: "in-progress", detail: "Slice 24 adds operational reports CSV export, React Reports export visibility, Workbench actions, smoke coverage, and side-by-side report-export parity evidence." }
    ]
  });
});
