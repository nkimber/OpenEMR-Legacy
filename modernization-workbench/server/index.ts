...
app.get("/api/progress", async (_request, response) => {
  response.json({
    slices: [
      ...
      { id: "seed-data", name: "Synthetic seed data", status: "verified", detail: "Workbench owns the shared gold dataset; the 1,000-patient legacy seed now includes 2,648 immunization rows and is generated with count/temporal-coverage verification." },
      ...
      { id: "workflow-mutations", name: "Legacy workflow mutation suite", status: "verified", detail: "Implemented for demographics, insurance coverage, scheduling, encounters with vitals/SOAP details, clinical lists, problem lists, medication lists, patient messages, text and binary patient documents, prescriptions, immunizations, billing, and lab procedure lifecycle coverage with pre/post database probes." },
      { id: "test-management", name: "Parity test management", status: "verified", detail: "Named run plans are implemented for legacy readiness, isolated workflow mutations, patient chart parity, scheduling parity, encounter SOAP/vitals parity, clinical-list parity, messaging parity, insurance coverage parity, insurance mutation parity, immunization parity, patient-document parity, patient-document content parity, binary patient-document mutation parity, procedure-result parity, pending procedure-order parity, report-export parity, fee-sheet billing parity, administration directory parity, operational reporting parity, patient contact mutation parity, appointment mutation parity, encounter mutation parity, clinical-list mutation parity, problem-list mutation parity, medication-list mutation parity, patient-message mutation parity, patient-document mutation parity, prescription mutation parity, immunization mutation parity, billing mutation parity, procedure mutation parity, admin facility mutation parity, admin user mutation parity, access-control parity, access-permission mutation parity, user group membership mutation parity, and the future full parity contract." },
      { id: "modernized-target", name: "Modernized OpenEMR target", status: "in-progress", detail: "Slice 34 adds patient insurance coverage create, update, and delete lifecycle behavior to the Patient chart API and React Insurance panel, Workbench actions, smoke coverage, and side-by-side insurance mutation parity evidence." }
    ]
  });
});
