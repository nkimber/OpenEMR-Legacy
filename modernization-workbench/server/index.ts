...
app.get("/api/progress", async (_request, response) => {
  response.json({
    slices: [
      ...
      { id: "workflow-mutations", name: "Legacy workflow mutation suite", status: "verified", detail: "Implemented for demographics, patient registration, insurance coverage, scheduling, encounters with vitals/SOAP details, clinical lists, problem lists, medication lists, patient messages, text/binary/sign-off/denial/metadata/archive/content-replacement/external-link patient documents, prescriptions, immunizations, billing, billing diagnosis coding, billing charge correction, billing modifier, and lab procedure lifecycle coverage with pre/post database probes." },
      { id: "test-management", name: "Parity test management", status: "verified", detail: "Named run plans are implemented for legacy readiness, isolated workflow mutations, patient chart parity, patient demographics mutation parity, patient registration parity, scheduling parity, encounter SOAP/vitals parity, encounter metadata parity, clinical-list parity, messaging parity, insurance coverage parity, insurance mutation parity, immunization parity, patient-document parity, patient-document content parity, patient-document preview parity, patient-document revision parity, binary patient-document mutation parity, patient-document sign-off parity, patient-document denial parity, patient-document metadata parity, patient-document archive parity, patient-document content replacement parity, patient-document external-link parity, procedure-result parity, pending procedure-order parity, report-export parity, fee-sheet billing parity, claim status parity, payment posting parity, account balance parity, account aging parity, account ledger parity, account statement parity, administration directory parity, operational reporting parity, patient contact mutation parity, appointment mutation parity, encounter mutation parity, clinical-list mutation parity, problem-list mutation parity, medication-list mutation parity, patient-message mutation parity, patient-document mutation parity, prescription mutation parity, immunization mutation parity, billing mutation parity, billing diagnosis mutation parity, billing correction mutation parity, billing modifier mutation parity, procedure mutation parity, admin facility mutation parity, admin user mutation parity, access-control parity, access-permission mutation parity, user group membership mutation parity, and the future full parity contract." },
      { id: "modernized-target", name: "Modernized OpenEMR target", status: "in-progress", detail: "Slice 54 adds current document revision-readiness facts over seeded patient-document rows, API/Documents rendering, Workbench actions, smoke coverage, and side-by-side document revision parity evidence." }
    ]
  });
});
