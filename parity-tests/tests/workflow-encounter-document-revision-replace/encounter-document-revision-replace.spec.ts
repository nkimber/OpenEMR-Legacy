  ...
  test("replacement updates the current revision facts for an encounter-attached document", async ({
    ...
    try {
      ...
      if (target.type === "legacy-openemr") {
        ...
        await page.getByLabel("Encounter from date").fill(encounterDocumentRevisionReplaceFromDate);
      ...
      if (target.type === "legacy-openemr") {
        ...
        const response = await page.request.get(`${target.apiBaseUrl}/api/encounters/${encounterDocumentRevisionReplaceEncounter}`);
